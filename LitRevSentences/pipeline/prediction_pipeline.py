...
class PredictionPipeline:
    ...
    def get_model_from_gcloud(self) -> str:
        ...
        try:
            ...
            return best_model_path, text_vectorizer, token_embed, label_encoder
    ...
    def predict(self,LitRev):
        ...
        try:
            best_model_path, text_vectorizer, token_embed, label_encoder  = self.get_model_from_gcloud()
            ...
            sentences_list = self.text_preprocess_predict(LitRev=LitRev)
            ...
            result = pd.DataFrame({'Category': test_pred_classes, 'Sentence': sentences_list})
